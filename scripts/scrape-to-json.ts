...
(async () => {
    ...
    while (true) {
        ...
        const newTitleCount = await page.evaluate(() => document.querySelectorAll('.Comp_Title').length);
        const skeletonRows = await page.evaluate(() => document.querySelectorAll('.CompRowPlaceholder').length);
        const skeletonTitles = await page.evaluate(() => document.querySelectorAll('.CompTitlePlaceholder').length);
        console.log('CompRow:', newCompCount, 'Comp_Title:', newTitleCount, 'SkeletonRows:', skeletonRows, 'SkeletonTitles:', skeletonTitles);
