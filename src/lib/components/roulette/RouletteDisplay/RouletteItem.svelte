...
<div
	class="relative mx-1 box-border flex h-48 flex-shrink-0 flex-col rounded-xl border-2 bg-gray-800/80 p-1.5 shadow-lg transition-transform duration-300 ease-in-out hover:z-10 hover:scale-105"
